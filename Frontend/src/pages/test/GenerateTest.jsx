        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/10 rounded-3xl p-8 mb-8 backdrop-blur-xl">
            ...
            <p className="text-gray-400 text-lg">
              Generate personalized AI-powered tests based on your selected exam
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl">
            ...
            <label className="block mb-2 text-gray-300">Select Exam</label>
            ...
            <label className="block mb-2 text-gray-300">Difficulty Level</label>
            ...
            <div className="grid md:grid-cols-3 gap-4 mb-8">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-5">
                <h3 className="font-semibold text-blue-400 mb-2">Study Plan</h3>
